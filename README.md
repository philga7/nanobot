...
<div align="center">
  <img src="./images/nanobot_logo.png" alt="nanobot" width="420">
  <h1>nanobot</h1>
  <p>
    <strong>Personal fork</strong> —
    <a href="https://github.com/philga7/nanobot">philga7/nanobot</a>
    tracks
    <a href="https://github.com/HKUDS/nanobot">HKUDS/nanobot</a>
    with maintainer-specific additions (OSINT skill, deployment docs, cron hooks).
  </p>
  <p>
  ...
  <p>
    ...
    <a href="https://github.com/HKUDS/nanobot/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflows/ci.yml/badge.svg?branch=main" alt="Test Suite"></a>
    ...
    <a href="https://github.com/philga7/nanobot"><img src="https://img.shields.io/badge/GitHub-philga7%2Fnanobot-181717?logo=github" alt="This fork"></a>
...
For fork-specific areas (OSINT skill, multi-instance configs, compose overlays, operator docs), see [AGENTS.md](AGENTS.md), [INSTANCES.md](INSTANCES.md), [DOCKER.md](DOCKER.md), and [docs/WREN_UPDATE_WORKFLOW.md](docs/WREN_UPDATE_WORKFLOW.md).
