...
- Builds Slack **mrkdwn** (trimmed to ~1500 words): `*bold*`, `_italic_`, `<https://example.com|label>` links for story URLs, source lines, and apps; plain `https://…` in summaries is linkified the same way.
