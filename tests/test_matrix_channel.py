...
try:
    import nanobot.channels.matrix as matrix_module  # type: ignore[assignment]
    ...
    pytest.skip("Matrix dependencies not installed; skipping Matrix channel tests.", allow_module_level=True)
